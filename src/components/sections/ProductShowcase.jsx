    ...
    <section id="product-showcase" className="py-20 bg-gradient-to-br from-indigo-50 to-purple-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          >
            Powerful <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Features</span>, Simple Experience
          </motion.h2>
          <motion.p
                    ...
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-primary-600">12:45</div>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                      <div className="divide-y divide-gray-200">
                        <div className="p-3 flex items-center justify-between hover:bg-gray-50">
                          ...
                          <button className="text-xs bg-primary-100 text-primary-700 px-2 py-1 rounded">Preview</button>
                        </div>
                        <div className="p-3 flex items-center justify-between hover:bg-gray-50">
                          <div className="flex items-center space-x-3">
                          ...
                          <button className="text-xs bg-gray-100 text-gray-500 px-2 py-1 rounded">Edit</button>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="relative z-10">
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className={`flex ${feature.position === 'right' ? 'md:flex-row-reverse text-right' : 'text-left'}`}
                initial={{ opacity: 0, x: feature.position === 'right' ? 30 : -30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: 0.2 + index * 0.1 }}
              >
                <div className={`flex-shrink-0 ${feature.position === 'right' ? 'md:ml-4' : 'md:mr-4'}`}>
