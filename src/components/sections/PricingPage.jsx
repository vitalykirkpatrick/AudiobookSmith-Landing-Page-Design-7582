        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => handleNavigateWithScroll('/#transform-form')} className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-semibold rounded-lg hover:from-primary-600 hover:to-secondary-600 transition-all transform hover:scale-105 shadow-lg">
            ...
            <>
              ...
              >
                <div className="p-6 h-screen overflow-y-auto">
                  <motion.button
                    onClick={() => { setIsMobileMenuOpen(false); handleNavigateWithScroll('/#transform-form'); }}
