...
const CompactVoiceCloning = () => {
  ...
  const ELEVENLABS_API_KEY = process.env.REACT_APP_ELEVENLABS_API_KEY || 'sk_b006ebce7fa44b04bdc0037b5858fbdaa62e85688177a5b4';
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="text-center">
                      <button 
                        ...
                        className={`w-16 h-16 rounded-full flex items-center justify-center text-white transition-colors mb-2 ${
                          inputMethod === 'upload' 
                          ...
                          <button
                            ...
                            className={`ml-4 p-2 ${
                              playingVoiceId === voice.id
                                ? 'bg-red-500'
                                : 'bg-primary-500'
                            } text-white rounded-full hover:opacity-90 transition-colors`}
                          >
                            <SafeIcon
                              icon={playingVoiceId === voice.id ? FiPause : FiPlay}
                              className="w-4 h-4"
                            />
                          </button>
                        </div>
