        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <button
                onClick={() => handleNavigateWithScroll('/voice-samples')}
                className="text-gray-700 hover:text-primary-600 transition-colors cursor-pointer"
              >
                Voices Demo
              </button>
              <button
                onClick={() => handleNavigateWithScroll('/pricing')}
                className="text-gray-700 hover:text-primary-600 transition-colors cursor-pointer"
              >
                Pricing
              </button>
                ...
                <div className="p-6 h-screen overflow-y-auto">
                  ...
                  <nav className="space-y-2">
                    <MobileNavLink
                      ...
                      icon={BsBook}
                      label="Features"
                      description="Explore our powerful tools"
                    />
                    ...
                    <MobileNavLink
                      ...
                      icon={FiPlay}
                      label="How It Works"
                      description="See our simple process"
                    />
                    ...
                    <MobileNavLink
                      ...
                      icon={FiVolume2}
                      label="Voice Samples"
                      description="Listen to AI voices"
                    />
